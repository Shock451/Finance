<?php
	...
	/**
	 * Congratulate with a message
	 */
    function congratulate($message)
    {
        render("congratulations.php", ["message" => $message]);
        exit;
    }
	...
	/**
	 * Renders template with options, passing in values.
	 */
	 function renderx($template, $values = [])
    {
        // if template exists, render it
        if (file_exists("../templates/$template"))
        {
            ...
            // render footer            
            require("../templates/footerIn.php");
        }
