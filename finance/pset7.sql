...
CREATE TABLE `history` (
  ...
  `Transaction` varchar(7) COLLATE utf8_unicode_ci NOT NULL,
  `Period` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Shares` int(11) NOT NULL,
  PRIMARY KEY (`id`,`Price`,`Symbol`,`Transaction`,`Shares`)
...
INSERT INTO `portfolios` VALUES (1,'FREE',15000),(2,'AAC',2500),(3,'ABB',1450),(4,'ACM',5700),(5,'ACW',300),(6,'ACV',3140),(7,'ACC',250);
...
-- Dump completed on 2015-12-03 18:59:31
